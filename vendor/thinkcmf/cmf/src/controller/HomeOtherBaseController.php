...
class HomeOtherBaseController extends BaseController
{
...
hello;
    ...
    public function assembleWxhostConfig($token, $requrl)
    {
        ...
        $config = [
            ...
            'oauth' => [
                ...
                'callback' => 'jiaxiao/index/oauthcallback?token=' . $wxconfig[0]['token'] . '&requrl=' . $requrl,
            ],
        ];
        return $config;
    }
    ...
    public function creatuser()
    {
        ...
        if (count($uresult) > 0) {
            ...
            $result = $this->random(4, '123456789abcdefghijklmnpqrstuvwxyz');
            $user_login = $this->random(8, '123456789abcdefghijklmnpqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ');
            $user['code'] = $result;
...
//            }
            ...
            die("<div style='text-align: center;font-size: 80px;'>请用微信客户端打开!</div>");
        }
        return false;
    }
...
//        return "oAWh1xCByOheaFrAcBthZ5kTpo5c";
    }
